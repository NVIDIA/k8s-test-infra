...
// nvlinkBwMode ports the bandwidth-mode block of validate-nvlink.sh. Below the
// gate it asserts the negative direction, which is what keeps the architecture
// gate from silently degrading into a blanket success.
