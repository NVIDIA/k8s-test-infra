...
func validFixture(t *testing.T) (options, *mokkav1alpha1.SGPUInventory, *mokkav1alpha1.SGPURackList, *corev1.NodeList) {
	...
	inventory := &mokkav1alpha1.SGPUInventory{
		...
		Spec: mokkav1alpha1.SGPUInventorySpec{RackGroups: []mokkav1alpha1.SGPURackGroup{{
			ID: "compute", Count: 1, ProfileRef: corev1.LocalObjectReference{Name: "mokka-kwok"},
		}}},
		Status: mokkav1alpha1.SGPUInventoryStatus{
			ObservedGeneration: 1,
			Capacity:           mokkav1alpha1.SGPUCapacity{Racks: 1, NodeSlots: 1, GPUs: 1},
			Usage:              mokkav1alpha1.SGPUUsage{RequestedNodes: 1, AllocatedNodes: 1, ProjectedNodes: 1},
			Conditions:         conditions("Accepted", "ResolvedRefs", "Materialized", "RequestsSatisfied", "NodesProjected"),
		},
	}
	...
	rack := mokkav1alpha1.SGPURack{
		...
		Status: mokkav1alpha1.SGPURackStatus{
			ObservedGeneration: 1, AssignedSlots: 1, ProjectedSlots: 1,
			Conditions: conditions("Ready", "NodesProjected"),
		},
	}
