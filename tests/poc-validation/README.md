# nvml-mock PoC Validation

Reproducible scripts for validating NVIDIA GPU consumers (device plugin, DRA driver) against the nvml-mock infrastructure on Kind clusters.
...
|----------|---------|-------------|
| `GPU_PROFILE` | `a100` | GPU profile (a100, h100, b200, gb200, gb300, l40s, t4, vr200) |
