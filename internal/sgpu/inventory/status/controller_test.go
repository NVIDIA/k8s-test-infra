...
func TestRackAPIInvalidProfileIssueSurfacesInvalidProfileStatus(t *testing.T) {
	...
	input.RackResult.ProfileIssues = []sgpuinventory.ProfileIssue{{
...
func aggregateInput(t testing.TB) InventoryInput {
	...
	return InventoryInput{
		...
		RackResult: sgpuinventory.Result{
			...
			ProfileIssues: []sgpuinventory.ProfileIssue{{RackGroup: "missing", ProfileName: "missing", Reason: "NotFound"}},
