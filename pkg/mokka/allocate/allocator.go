...
//nolint:revive // Release reasons form one closed allocation lifecycle vocabulary.
const (
	// ReleaseGroupRemoved retires a binding whose allocation group no longer exists.
...
//nolint:revive // Conflict kinds form one closed allocation diagnostic vocabulary.
const (
	// ConflictSelectorOverlap identifies a Node selected by multiple groups.
