...
type SGPUInventoryInformer interface {
	...
	Lister() mokkav1alpha1.SGPUInventoryLister
}
...
func NewSGPUInventoryInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) cache.SharedIndexInformer {
	...
	return cache.NewSharedIndexInformerWithOptions(
		...
		&apismokkav1alpha1.SGPUInventory{},
...
func (f *sGPUInventoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apismokkav1alpha1.SGPUInventory{}, f.defaultInformer)
}

func (f *sGPUInventoryInformer) Lister() mokkav1alpha1.SGPUInventoryLister {
	return mokkav1alpha1.NewSGPUInventoryLister(f.Informer().GetIndexer())
}
