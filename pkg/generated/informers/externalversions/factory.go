...
import (
	...
	mokka "github.com/NVIDIA/k8s-test-infra/pkg/generated/informers/externalversions/mokka"
...
type SharedInformerFactory interface {
	...
	Mokka() mokka.Interface
}

func (f *sharedInformerFactory) Mokka() mokka.Interface {
	return mokka.New(f, f.namespace, f.tweakListOptions)
}
