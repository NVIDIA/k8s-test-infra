...
| Surface                                                                                                    | Consumers                                                                  | Coverage                                                                                                                                                                         |
|------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `/sys/class/infiniband/mlx5_<N>/*`                                                                         | Network Operator, `ibstat`, `ibv_devinfo`, DCGM fabric metrics, Topograph  | ✓ `ib` via `internal/ib/render` — full HCA surface (18 file attributes + `gids/`, `pkeys/`, `counters/`, `gid_attrs/` subdirs); `gids/0` derived as `fe80::+port_guid` |
