# MEP-NNNN: Your short, descriptive title

<!--
This is the title of your MEP. Keep it short, simple, and descriptive. A good
title can help communicate what the MEP is and should be considered as part of
any review.
-->

<!--
A table of contents is helpful for quickly jumping to sections of a MEP and for
highlighting any additional information provided beyond the standard MEP
template.
-->
...
<!--
Explicitly list the motivation, goals, and non-goals of this MEP.
Describe why the change is important and the benefits to users. Link to
issues, incidents, or discussions that surfaced the need — concrete
evidence is stronger than abstract argument.
-->
