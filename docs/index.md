...
- Running a workload *on* a MIG slice, and Confidential Computing. Creating,
  ...
  [MIG partitioning](guides/mig/README.md) — but there is no CUDA, so a slice admits a
